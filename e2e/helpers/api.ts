...
export interface ApiClient {
  ...
  getPhoto(photoId: string): Promise<unknown>;
...
export async function uploadPhotoViaApi(
  ...
  formData.append('photo', new Blob([minimalJpeg], { type: 'image/jpeg' }), 'test-photo.jpg');
  formData.append(
    'thumbnail',
...
export async function makeDirectApiCall(
  request: APIRequestContext,
